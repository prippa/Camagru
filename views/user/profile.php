        ...
        <div class="row mr-2 ml-2 justify-content-center">
            ...
            <div class="col-12 mt-3 col-radius-form">
                <div class="form-check">
                    <input name="notifications" type="checkbox" class="form-check-input" id="notifications-field">
            ...
            <div class="col-12 text-center">
                <hr>
                <button type="submit" class="btn btn-primary settings-btn" tabindex="7">Change</button>
            </div>
        </div>
    </form>
